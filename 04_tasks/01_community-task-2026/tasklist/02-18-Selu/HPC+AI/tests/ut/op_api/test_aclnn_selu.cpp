...
TEST_F(selu_test, test_selu_FP32) {
  auto inputDesc = TensorDesc({2, 16}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-100, 100);
...
TEST_F(selu_test, test_selu_FP16) {
  auto inputDesc = TensorDesc({2, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-100, 100);
...
TEST_F(selu_test, test_selu_INT32) {
  auto inputDesc = TensorDesc({2, 16}, ACL_INT32, ACL_FORMAT_ND).ValueRange(-100, 100);
  auto outDesc = TensorDesc({2, 16}, ACL_INT32, ACL_FORMAT_ND).Precision(0, 0);
...
TEST_F(selu_test, test_selu_INT8) {
  auto inputDesc = TensorDesc({2, 16}, ACL_INT8, ACL_FORMAT_ND).ValueRange(-100, 100);
  auto outDesc = TensorDesc({2, 16}, ACL_INT8, ACL_FORMAT_ND).Precision(0, 0);
...
TEST_F(selu_test, test_selu_BF16) {
  auto inputDesc = TensorDesc({2, 16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(-100, 100);
  auto outDesc = TensorDesc({2, 16}, ACL_BF16, ACL_FORMAT_ND).Precision(0.001, 0.001);
