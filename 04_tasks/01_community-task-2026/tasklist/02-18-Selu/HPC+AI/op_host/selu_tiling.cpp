...
constexpr uint32_t UB_DATA_NUMBER_FLOAT  =   9;
constexpr uint32_t UB_DATA_NUMBER_FLOAT16 = 13;
constexpr uint32_t UB_DATA_NUMBER_INT8 =    35;
constexpr uint32_t UB_DATA_NUMBER_INT32 =    9;
constexpr uint32_t UB_DATA_NUMBER_BF16 =    13; 
const std::set<ge::DataType> supportedDtype = {ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_INT8, ge::DT_INT32};
...
static ge::graphStatus GetShapeAttrsInfo(gert::TilingContext* context, ge::DataType& dataType, int64_t& inputLength,int32_t& inputBytes, int32_t& dataNumber)
{
    ...
    if (dataType == ge::DT_FLOAT){
        ...
        dataNumber = UB_DATA_NUMBER_INT8;    
    }
    else if (dataType == ge::DT_INT32){  
        dataNumber = UB_DATA_NUMBER_INT32;    
    }
...
static ge::graphStatus SeluTilingFunc(gert::TilingContext* context)
{
    ...
    OP_CHECK_IF(memset_s(tiling, sizeof(SeluTilingData), 0, sizeof(SeluTilingData)) != EOK,OP_LOGE(context, "set tiling data error"), return ge::GRAPH_FAILED);
